...
<!-- Mirrored from jthemes.net/themes/html/wizard-form/v1/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 Nov 2024 05:37:41 GMT -->
<head>
	<meta charset="utf-8">
	<title>Grants Multiform</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" href="{{asset('public/assets/css/bootstrap.min.css')}}">
	<link rel="stylesheet" href="{{asset('public/assets/cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/css/bootstrap-datepicker.css')}}">
	...
	<!-- Color Alternatives -->
	<link href="{{asset('public/assets/css/colors/color-2.css')}}" rel="alternate stylesheet" type="text/css" title="color-2">
	<link href="{{asset('public/assets/css/colors/color-3.css')}}" rel="alternate stylesheet" type="text/css" title="color-3">
	<link href="{{asset('public/assets/css/colors/color-4.css')}}" rel="alternate stylesheet" type="text/css" title="color-4">
	<link href="{{asset('public/assets/css/colors/color-5.css')}}" rel="alternate stylesheet" type="text/css" title="color-5">
</head>
...
<body>
	...
	<div class="wrapper">
		<div class="steps-area steps-area-fixed">
			<div class="image-holder">
				<img src="{{asset('public/assets/img/side-img.jpg')}}" alt="">
			</div>
										...
										<div class="row">
											<div class="col-md-4">
												<label class="step-box-content bg-white text-center relative-position active">
													<span class="step-box-icon">
														<img src="{{asset('public/assets/img/d1.png')}}" alt="">
													</span>
											...
											<div class="col-md-4">
												<label class="step-box-content bg-white text-center relative-position">
													<span class="step-box-icon">
														<img src="{{asset('public/assets/img/d2.png')}}" alt="">
													</span>
													<span class="step-box-text">
											...
											<div class="col-md-4">
												<label class="step-box-content bg-white text-center relative-position">
													<span class="step-box-icon">
														<img src="{{asset('public/assets/img/d3.png')}}" alt="">
													</span>
													<span class="step-box-text">
														Development
													</span>
	...
	<script src="{{asset('public/assets/cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/js/bootstrap-datepicker.min.js')}}"></script>
	<script src="{{asset('public/assets/js/bootstrap.min.js')}}"></script>
	<script src="{{asset('public/assets/js/conditionize.flexible.jquery.min.js')}}"></script>
...
<!-- Mirrored from jthemes.net/themes/html/wizard-form/v1/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 Nov 2024 05:37:49 GMT -->
</html>